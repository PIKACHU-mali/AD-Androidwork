...
import com.example.nus.ui.screens.ViewRequestScreen
...
sealed class Screen(val route: String, val title: String) {
    ...
    object ViewRequests : Screen("view_requests", "Requests")
}
...
fun AppNavigation() {
    ...
    val viewRequestViewModel: ViewRequestViewModel = viewModel()
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(Screen.ViewRequests.route) {
                ViewRequestScreen(viewModel = viewRequestViewModel)
            }
        }
    }
} 