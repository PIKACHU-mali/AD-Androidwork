	...
	CommandLineRunner ormTest(JournalUserRepository userRepo, EmotionRepository emoRepo,
		...
		return args -> {
			...
			*/
			...
			/*
			JournalUser testUser = userRepo.findJournalUserByEmail("firstTest@email.com").orElseThrow();
